...
urlpatterns: List[URLPattern] = [
    ...
    path(route='checkout/',
         ...
         name='checkout'),
    path(route='thank-you/',
         view=views.ThankYouView.as_view(),
         name='thank-you'),
    path(route='shop/',
         view=views.ProductListView.as_view(),
         name='product-list'),
    path(route='orders/<pk>/',
         view=views.OrderDetailView.as_view(),
         name='order-detail'),
    path(route='webhooks/stripe/',
         view=views.stripe_webhook_view,
         name='stripe-webhook'),
    path(route='shop/<slug>/',
         view=views.ProductDetailView.as_view(),
         name='product-detail'),
    path(route='confirm-order/',
         view=views.ConfirmOrderView.as_view(),
         name='confirm-order'),
    path(route='payment/stripe/',
         view=views.StripePaymentView.as_view(),
         name='payment-stripe'),
    path(
